...
public class PaymentsUtil
{
    ...
    public static PaymentsClient createPaymentsClient(Activity activity)
    {
        Wallet.WalletOptions walletOptions =
                new Wallet.WalletOptions.Builder().setEnvironment(
                        GooglePayConstants.PAYMENTS_ENVIRONMENT)
                                                  .build();
     ...
     *
     * <p>TODO: Check with your gateway on the parameters to pass and modify them in GooglePayConstants.java.
     *
     ...
     *
     * <p>TODO: Confirm card networks supported by your app and gateway & update in GooglePayConstants.java.
     *
    ...
    public static Optional<JSONObject> getPaymentDataRequest(String price)
    {
        try
        {
            ...
            paymentDataRequest.put(
                    ...
                    new JSONArray().put(PaymentsUtil.getCardPaymentMethod()));
      ...
      JSON object. */
            ...
            JSONArray allowedCountryCodes = new JSONArray(
                    GooglePayConstants.SHIPPING_SUPPORTED_COUNTRIES);
