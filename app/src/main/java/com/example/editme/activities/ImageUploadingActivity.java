...
import com.example.editme.services.MyDownloadService;
import com.example.editme.services.MyUploadService;
...
public class ImageUploadingActivity
        ...
        implements View.OnClickListener
{
        ...
        mBroadcastReceiver = new BroadcastReceiver()
        {
            ...
            public void onReceive(Context context, Intent intent)
            {
                ...
                case MyDownloadService.DOWNLOAD_COMPLETED:
                    ...
                    long numBytes = intent.getLongExtra(MyDownloadService.EXTRA_BYTES_DOWNLOADED,
                                                        0);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (requestCode == RC_TAKE_PICTURE)
        {
            ...
            {
                Toast.makeText(this, "Taking picture failed.", Toast.LENGTH_SHORT)
                     .show();
            }
        }
    }
